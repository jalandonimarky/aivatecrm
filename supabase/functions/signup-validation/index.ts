/// <reference lib="deno.ns" />
    ...
    serve(async (req) => {
      ...
      try {
        ...
        console.log("Edge Function: createUser call completed.");

        if (signUpError) {
          console.error('Edge Function: Supabase signup error:', signUpError.message);
        ...
        console.log('Edge Function: User created successfully, user ID:', user?.user?.id);
