            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  required
                  className="focus-visible:outline-none focus-visible:ring-transparent focus-visible:ring-offset-transparent"
                />
              </div>
              <div className="space-y-2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Popover open={isCalendarOpen} onOpenChange={setIsCalendarOpen}>
                    <PopoverTrigger asChild>
                      <Button variant={"outline"} className={cn("w-full justify-start text-left font-normal focus-visible:outline-none focus-visible:ring-transparent focus-visible:ring-offset-transparent", !formData.due_date && "text-muted-foreground")}>
                ...
                <div className="space-y-2">
                  ...
                  <Input id="item-event-time" type="time" value={formData.event_time || ""} onChange={(e) => handleInputChange('event_time', e.target.value)} className="focus-visible:outline-none focus-visible:ring-transparent focus-visible:ring-offset-transparent" />
                </div>
              </div>
            </div>
          </ScrollArea>
