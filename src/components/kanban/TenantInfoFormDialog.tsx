          ...
          <ScrollArea className="h-[70vh] p-4">
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                >
                  <SelectTrigger className="focus-visible:outline-none focus-visible:ring-transparent focus-visible:ring-offset-transparent">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input id="tenant-name" value={formData.tenant_contact_full_name || ""} onChange={(e) => handleInputChange('tenant_contact_full_name', e.target.value)} className="focus-visible:outline-none focus-visible:ring-transparent focus-visible:ring-offset-transparent" />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="tenant-phone">Tenant Phone</Label>
                  <Input id="tenant-phone" value={formData.tenant_contact_phone || ""} onChange={(e) => handleInputChange('tenant_contact_phone', e.target.value)} className="focus-visible:outline-none focus-visible:ring-transparent focus-visible:ring-offset-transparent" />
                </div>
              </div>
              <div className="space-y-2">
                <Label htmlFor="tenant-email">Tenant Email</Label>
                <Input id="tenant-email" type="email" value={formData.tenant_contact_email || ""} onChange={(e) => handleInputChange('tenant_contact_email', e.target.value)} className="focus-visible:outline-none focus-visible:ring-transparent focus-visible:ring-offset-transparent" />
              </div>
              <div className="space-y-2">
                <Label htmlFor="household-comp">Household Composition</Label>
                <Textarea id="household-comp" value={formData.household_composition || ""} onChange={(e) => handleInputChange('household_composition', e.target.value)} rows={2} className="focus-visible:outline-none focus-visible:ring-transparent focus-visible:ring-offset-transparent" />
              </div>
              <div className="space-y-2">
                <Label htmlFor="pets-info">Pets Info</Label>
                <Input id="pets-info" value={formData.pets_info || ""} onChange={(e) => handleInputChange('pets_info', e.target.value)} className="focus-visible:outline-none focus-visible:ring-transparent focus-visible:ring-offset-transparent" />
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="bedrooms">Bedrooms Needed</Label>
                  <Input id="bedrooms" type="number" value={formData.bedrooms_needed || ""} onChange={(e) => handleInputChange('bedrooms_needed', e.target.value)} className="focus-visible:outline-none focus-visible:ring-transparent focus-visible:ring-offset-transparent" />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="bathrooms">Bathrooms Needed</Label>
                  <Input id="bathrooms" type="number" value={formData.bathrooms_needed || ""} onChange={(e) => handleInputChange('bathrooms_needed', e.target.value)} className="focus-visible:outline-none focus-visible:ring-transparent focus-visible:ring-offset-transparent" />
                </div>
              </div>
              <div className="space-y-2">
                <Label htmlFor="locations">Preferred Locations</Label>
                <Input id="locations" value={formData.preferred_locations || ""} onChange={(e) => handleInputChange('preferred_locations', e.target.value)} className="focus-visible:outline-none focus-visible:ring-transparent focus-visible:ring-offset-transparent" />
              </div>
              <div className="space-y-2">
                ...
                <Popover open={isMoveInCalendarOpen} onOpenChange={setIsMoveInCalendarOpen}>
                  <PopoverTrigger asChild>
                    <Button variant={"outline"} className={cn("w-full justify-start text-left font-normal focus-visible:outline-none focus-visible:ring-transparent focus-visible:ring-offset-transparent", !formData.desired_move_in_date && "text-muted-foreground")}>
