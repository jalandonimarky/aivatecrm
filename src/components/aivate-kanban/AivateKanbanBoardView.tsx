...
import { AivateKanbanColumn } from "./AivateKanbanColumn";
import { Button } from "@/components/ui/button";
import { Plus } from "lucide-react";
import { useToast } from "@/hooks/use-toast";
import type { AivateKanbanBoard as AivateKanbanBoardType, AivateKanbanColumn as AivateKanbanColumnType, AivateKanbanItem as AivateKanbanItemType } from "@/types/crm";

interface AivateKanbanBoardViewProps {
  board: AivateKanbanBoardType;
...
export function AivateKanbanBoardView({
  board,
  onAddColumn,
  onEditColumn,
  onDeleteColumn,
  ...
  return (
    <DragDropContext onDragEnd={onDragEnd}>
      <Droppable droppableId="all-aivate-columns" direction="horizontal" type="column">
        {(provided) => (
          <div
