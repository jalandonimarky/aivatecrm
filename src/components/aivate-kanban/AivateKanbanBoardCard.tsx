...
interface AivateKanbanBoardCardProps {
  board: AivateKanbanBoard;
  onSelect: (boardId: string) => void;
  onEdit: (board: AivateKanbanBoard) => void;
  onDelete: (boardId: string) => void;
}

export function AivateKanbanBoardCard({ board, onSelect, onEdit, onDelete }: AivateKanbanBoardCardProps) {
  return (
