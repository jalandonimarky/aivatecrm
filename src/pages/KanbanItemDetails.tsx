...
import type { KanbanItem, KanbanItemActivity, KanbanBoard } from "@/types/crm";

export function KanbanItemDetails() {
  const { kanbanItems, kanbanBoards, profiles, loading, updateKanbanItem, deleteKanbanItem, getFullName } = useCRMData();
