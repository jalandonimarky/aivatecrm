...
export const kanbanBoardColors = [
  {
    key: 'mint',
    name: 'Mint',
    light: 'linear-gradient(135deg, hsl(150, 70%, 85%) 0%, hsl(150, 70%, 95%) 100%)', // Sharper mint gradient
    dark: 'linear-gradient(135deg, hsl(150, 42%, 20%) 0%, hsl(150, 42%, 12%) 100%)',
  },
  {
    key: 'sky',
    name: 'Sky',
    light: 'linear-gradient(135deg, hsl(210, 80%, 85%) 0%, hsl(210, 80%, 95%) 100%)', // Sharper sky gradient
    dark: 'linear-gradient(135deg, hsl(210, 69%, 25%) 0%, hsl(210, 69%, 15%) 100%)',
  },
  {
    key: 'peach',
    name: 'Peach',
    light: 'linear-gradient(135deg, hsl(30, 80%, 85%) 0%, hsl(30, 80%, 95%) 100%)', // Sharper peach gradient
    dark: 'linear-gradient(135deg, hsl(30, 42%, 25%) 0%, hsl(30, 42%, 15%) 100%)',
  },
  {
    key: 'lavender',
    name: 'Lavender',
    light: 'linear-gradient(135deg, hsl(250, 80%, 88%) 0%, hsl(250, 80%, 96%) 100%)', // Sharper lavender gradient
    dark: 'linear-gradient(135deg, hsl(250, 42%, 25%) 0%, hsl(250, 42%, 15%) 100%)',
  },
  {
    key: 'yellow',
    name: 'Soft Yellow',
    light: 'linear-gradient(135deg, hsl(50, 80%, 85%) 0%, hsl(50, 80%, 95%) 100%)', // Sharper yellow gradient
    dark: 'linear-gradient(135deg, hsl(50, 42%, 25%) 0%, hsl(50, 42%, 15%) 100%)',
  },
  {
    key: 'blush',
    name: 'Blush',
    light: 'linear-gradient(135deg, hsl(350, 80%, 88%) 0%, hsl(350, 80%, 96%) 100%)', // Sharper blush gradient
